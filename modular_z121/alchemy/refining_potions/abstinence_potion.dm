...
// ============================================================================
// 配方：★按气味等级①★ 5 级"平静"气味 + 底料(乳汁 30 + 情欲液 30) → 禁欲药水 50。技能：熟练。
// ----------------------------------------------------------------------------
// 中文：
...
//   · 与【驱兽药水】(同气味"平静"但底料为水+魔力药水)以液体底料区分。
// ============================================================================
/datum/alch_refining_formula/forced_chastity
	name = "禁欲药水"										// Formula name.
	required_scent = "平静"								// 原版七叶草药剂(lck_potion)的 smells_like (Potion of Seven Clovers).
